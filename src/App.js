...
class App extends Component {
  ...
  render() {
    return <div className="App container">
      { this.state.authenticated ? <div><h1 className='center grey-text'>All the Tasks!</h1>
      <Tasks finishTask={this.finishTask} tasks={this.state.tasks}/>
      <AddTask createTask={this.createTask} /></div> : <Login authenticateUser={this.authenticateUser} />}
    </div>;
  }
}
